  ...
  $("#searchBtn").on("click", function () {
    ...
    $.ajax({
      ...
      <div class="card-body m-auto">
        ...
        <button type="button" class="btn btn-outline-danger btn-sm" data-name="${petName}" data-age="${petAge}" data-gender="${petGender}" data-size="${petSize}" data-url="${petWebLink}" data-img="${petIMGurl}">&hearts;</button>
      </div>
        `);
